...
class ListViewModelTests(unittest.TestCase):
    ...
    def test_none_value_is_preserved_and_displayed_as_none_label(self) -> None:
        ...
        self.assertIsNone(
            gamma_row.cells[2].value,
        )
        self.assertEqual(
            gamma_row.cells[2].display_value,
            "Aucune",
        )
    ...
    def test_format_boolean_true(self):
        builder = ListViewModelBuilder()

        self.assertEqual(
            builder._format_display_value(
                value=True,
                data_type="boolean",
            ),
            "Oui",
    ...
    def test_format_object_label(self):
        class LabelledValue:
